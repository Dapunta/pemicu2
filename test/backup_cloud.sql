...
--
-- Name: customer_customer_demo; Type: TABLE; Schema: public; Owner: avnadmin
--
...
ALTER TABLE public.customer_customer_demo OWNER TO avnadmin;

--
-- Name: customer_demographics; Type: TABLE; Schema: public; Owner: avnadmin
--
...
ALTER TABLE public.customer_demographics OWNER TO avnadmin;
...
--
-- Data for Name: customer_customer_demo; Type: TABLE DATA; Schema: public; Owner: avnadmin
--
...
--
-- Data for Name: customer_demographics; Type: TABLE DATA; Schema: public; Owner: avnadmin
--
...
--
-- Name: customer_customer_demo pk_customer_customer_demo; Type: CONSTRAINT; Schema: public; Owner: avnadmin
--
...
--
-- Name: customer_demographics pk_customer_demographics; Type: CONSTRAINT; Schema: public; Owner: avnadmin
--
...
--
-- Name: customers pk_customers; Type: CONSTRAINT; Schema: public; Owner: avnadmin
--
...
--
-- Name: customer_customer_demo fk_customer_customer_demo_customer_demographics; Type: FK CONSTRAINT; Schema: public; Owner: avnadmin
--
...
--
-- Name: customer_customer_demo fk_customer_customer_demo_customers; Type: FK CONSTRAINT; Schema: public; Owner: avnadmin
--
